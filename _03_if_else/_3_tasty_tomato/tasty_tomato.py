...
color = simpledialog.askstring(title='tomato color', prompt='Please choose the color of the tomato. you may chose red or orange(warning: orange looks a little yellow).')
